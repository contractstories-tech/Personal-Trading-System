...
CASES = [
    ...
    ("r5.6: composite tolerates a missing MATERIAL input (quality 4 of 5, all material)", A,
     setp(["composites", "quality_composite", "min_inputs_known"], 4), "would rank a security with a material input missing"),
    ("r5.6: composite needs more inputs than it has", A,
     setp(["composites", "consistency_composite", "min_inputs_known"], 4), "exceeds its 3 inputs"),

...
*Release r5.10 · 26 September 2026 · current state only · card sections generated from `strategies/*.yaml` by `render_cards.py` · cards pinned to their registry 3.1.0 closures*

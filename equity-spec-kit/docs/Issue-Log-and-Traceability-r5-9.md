# Issue Log & Traceability — Releases r5 / r5.1 / r5.2 / r5.3 / r5.4 / r5.5 / r5.6 / r5.7 / r5.8 / r5.9

*25 September 2026 · every finding from review indices 17–22 and 42–43, the independent assurance audit (F01–F16), Stage 0 (S0.x), the four external reviews of r5.3 (§10), the independent audit of r5.4 (§12) and the review of r5.5, run on Windows (§13), with its disposition*
